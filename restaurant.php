    ...
    <section id="popular-items" class="popular-items">
      <div class="container">
          <div class="row">
            ...
            <?php 
                $query_popularitems = "SELECT orders.restaurant_name as res_name,order_details.item_name as item_name, COUNT(*) as item_count, item.image as image
                                        FROM order_details
          ...
          <div class="new-arrivals-content">
              <div class="row">                  
                <?php 
                  ...
                  $time_shifts = array(
                      array('shift_name' => 'EarlyMorning', 'start_time' => '00:01', 'end_time' => '07:59'),
                       array('shift_name' => 'Morning', 'start_time' => '08:00', 'end_time' => '11:59'),
                      array('shift_name' => 'Afternoon', 'start_time' => '12:00', 'end_time' => '16:59'),
                      array('shift_name' => 'Dinner', 'start_time' => '17:00', 'end_time' => '23:59'),
                  );
                  ...
                  if ($current_shift) {
                      ...
                      $query_orders = "SELECT orders.restaurant_name as res_name,order_details.item_name as item_name, COUNT(*) as item_count, item.image as image
                                        FROM order_details
                                        JOIN orders ON orders.id = order_details.order_id
                                        JOIN item ON item.item_name = order_details.item_name

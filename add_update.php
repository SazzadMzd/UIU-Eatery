...
<html lang="en">
  ...
  <body>
    ...
    <div id="content" class="p-4 p-md-5 bg-ash" style="background-color:#F2E7E4;">
        <div class="container">
            <div class="menu_list mt-5 mb-5" >
                 <h2 class="text-center mb-5" style="color:blue;">CURRENT MENU LIST</h2>
                   ...
                   <?php 
                    ...
                    <?php foreach ($items as $item): ?>
                        <div class="row mb-3 border border-5 bg-white"> 
                            <div class="col-4">
                                <p class="text-bold"><?php echo $item['item_name']; ?></p>
                            </div>
                            <div class="col-3">
            ...
            <div class="add_update_items mt-5">
                <h2 class="text-left mb-5" style="color:blue;">ADD/UPDATE ITEMS</h2>

                <div class="item_form">
                      <form method="post" action="add_item_form_code.php">

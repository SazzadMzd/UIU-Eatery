    ...
    <div id="content" class="p-4 p-md-5 bg-ash" style="background-color:#F2E7E4;">
        <div class="container">
            ...
            <div class="add_update_items mt-5">
                ...
                <div class="item_form">
                      <form method="post" action="update_item_form_code.php" enctype="multipart/form-data">
                           <div class="d-flex justify-content-between">
                                    ...
                                    <div>
                                     ...
                                     <div>
                                        ...
                                        <label for="item_stock">Item Image <span style="font-bold:800, color:red;">(Optional)</span></label>
                    ...
                    <p>
                        <b>NB</b>: <span style="color:red;font-weight:bold;">Incase of editing item name, either delete this item and add new item</span>

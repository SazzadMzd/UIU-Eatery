...
#customers th {
  ...
  <body>
    ...
    <div id="content" class="p-4 p-md-5 bg-ash" style="background-color:#F2E7E4;">
        <div class="container">
            <div class="menu_list mt-5 mb-5" ><h1 class="text-center mb-5" style="color:#0B2161; font-family: serif; font-size: 32px;"><b>CURRENT Orders</b></h1>
...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $user = $_POST['user'];
    $sql = "INSERT INTO notification (user) 
        VALUES ('$user')";
